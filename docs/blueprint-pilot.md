...
After the pipeline passes, measure card sensitivity and unseen-infoset coverage before a longer campaign. A strength claim still requires the predeclared fresh, multi-seed scripted-opponent test in [`ROADMAP.md`](../ROADMAP.md).

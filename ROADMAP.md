...
- **Next task:** integrate the small-game snapshot archive with training/recovery and declare a fresh readiness protocol. The previous failed confirmation stays failed; avoid another open-ended parameter sweep.

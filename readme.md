...
**The [M4 higher-work campaign](docs/reports/holdem-local-fullgame.md) is complete:** both seeds finished 256 iterations with twice the earlier campaign's scheduled collection and fitting work. Fresh random-opponent tests return +40.81 and −0.69 BB/100; neither passes the declared competence check. Scripted-pool validation remains strongly negative. All campaign artifacts were retrieved and verified, and no model is promoted.
